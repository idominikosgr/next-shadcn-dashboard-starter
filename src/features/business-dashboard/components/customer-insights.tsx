...
export function CustomerInsights() {
  ...
  return (
    <Card className='via-background to-background border-border/50 h-fit bg-linear-to-br from-violet-500/5 shadow-elevation-1'>
      <CardHeader>
      ...
      <CardContent>
        <Tabs value={activeTab} onValueChange={setActiveTab} className='w-full'>
          <TabsList className='bg-muted/50 grid h-12 w-full grid-cols-3 rounded-lg p-1'>
            <TabsTrigger
              value='growth'
              className='data-[state=active]:bg-background data-[state=active]:text-foreground flex cursor-pointer items-center gap-2 rounded-md px-4 py-2 text-sm font-medium transition-all data-[state=active]:shadow-elevation-1'
            >
