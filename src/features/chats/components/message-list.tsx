...
export function MessageList({
  ...
  return (
    <ScrollArea className='h-full flex-1 overflow-auto' ref={scrollAreaRef}>
      <div className='space-y-4 px-4 py-4'>
        {messageGroups.map((group) => (
          <div key={group.date}>
            <div className='flex items-center justify-center py-4'>
              <div className='text-muted-foreground bg-muted/50 rounded-full px-4 py-1.5 text-xs font-medium'>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className='group/message relative'>
                        <div
                          className={cn(
                            'rounded-2xl px-4 py-2.5 text-sm wrap-break-word shadow-elevation-1',
                            isOwnMessage
                        ...
                        >
                          <div className='absolute top-1/2 right-1 z-10 -translate-y-1/2 opacity-0 transition-opacity group-hover/message:opacity-100'>
                            <DropdownMenu>
                              ...
                              {message.reactions.map((reaction, idx) => (
                                <div
                                  ...
                                  className={cn(
                                    ...
                                    'bg-background/90 shadow-elevation-1 glass-effect'
                                  )}
                                >
